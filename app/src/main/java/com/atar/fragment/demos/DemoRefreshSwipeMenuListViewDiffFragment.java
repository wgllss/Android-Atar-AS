...
import com.atar.fragment.AtarRefreshSwipeMenuListViewFragment;
...
public class DemoRefreshSwipeMenuListViewDiffFragment extends AtarRefreshSwipeMenuListViewFragment {
	...
	public void create(SwipeMenu menu) {
		...
		case 1:
			...
			item3.setIcon(R.mipmap.ic_action_important);
			...
			item4.setIcon(R.mipmap.ic_action_discard);
		...
		case 2:
			...
			item5.setIcon(R.mipmap.ic_action_about);
			...
			item6.setIcon(R.mipmap.ic_action_share);
