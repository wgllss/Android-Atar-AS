...
public class DemoRefreshActivity extends AtarRefreshListViewActivity {
    ...
    protected void initValue() {
        ...
        list.add(new MenuItemBean("0", "refresh-RecyclerView", DemoRefreshRecyclerViewActivity.class.getName()));
        list.add(new MenuItemBean("13", "refresh-ListView", DemoRefreshListViewActivity.class.getName()));
        ...
        list.add(new MenuItemBean("13", "refresh-In-Fragment", DemoRefreshInFragmentActivity.class.getName()));
