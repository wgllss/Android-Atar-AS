    ...
    public static void switchActivity(OnClickInfo onClickInfo, Context context) {
        try {
            if (onClickInfo != null) {
                ...
                if (className != null && className.contains("com.open.weex") && VERSION.SDK_INT < VERSION_CODES.ICE_CREAM_SANDWICH) {
    ...
    public static void switchMainTab(String specialInfo, String subTabClassActivityName) {
        try {
            if (specialInfo != null && specialInfo.length() > 0) {
                ...
                // if (ActivityManager.getActivityManager().getActivity(MainTabActivity.class) != null) {
                // ActivityManager.getActivityManager().getActivity(MainTabActivity.class).switchMainTab(tabHostposition, subTabClassActivityName, viewPagerItem);
                // }
            }
        } catch (Exception e) {
            ShowLog.e(TAG, CrashHandler.crashToString(e));
